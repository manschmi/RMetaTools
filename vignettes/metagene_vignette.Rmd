...
Handling R packages can be tricky, ie installing devtools which will be needed failed for me so better stick to 'conda' for handling such annoyancies. Ups: you will have to install conda as described in the genome.au.dk helppages.
...
install_github('manschmi/RMetaTools')
```
